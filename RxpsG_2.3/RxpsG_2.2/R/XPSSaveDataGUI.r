...
#         PathName may be changed by button CHANGE DIRECTORY
...
#===== Command Window =====
   ...
   SourceFrame <- gframe("Source File Name", spacing=5, horizontal=FALSE, container=group1)
   ...
   obj1 <- glabel("Destination Folder: ", container=SourceFrame)
   ...
   WhichDir <- gradio(c("Original Folder", "New Folder"), selected=1, horizontal=TRUE, container = SaveSepFrame)
